...
type Props = {
  /** Called when the visitor closes the dialog without subscribing. */
  onDismiss: () => void;
  /** Called once the signup request succeeds. */
  onSubscribed: () => void;
};

/** Newsletter signup dialog. Opens on mount; loaded on demand by NewsletterPopup. */
export function NewsletterDialog({ onDismiss, onSubscribed }: Props) {
